...
export default {
  ...
  assets: {
    ...
    'template-list/index.html': {size: 66957, hash: 'f91f78c9b2faf3e9623ae79a716ee04e9cc8cace7fe978c40f1b7d2bc53db340', text: () => import('./assets-chunks/template-list_index_html.mjs').then(m => m.default)},
